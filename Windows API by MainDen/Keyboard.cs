...
namespace MainDen.Windows.API
{
    ...
    public static partial class Keyboard
    {
        ...
        public enum VirtualKeyStates : int
        {
            ...
            Pause = 19,
            CapsLock, Capital = 20,
            Kana, KanaMode, ImeKana, Hanguel, HanguelMode, ImeHanguel, Hangul, HangulMode, ImeHangul = 21,
            ImeOn = 22,
            Junja, JunjaMode, ImeJunja = 23,
            Final, FinalMode, ImeFinal = 24,
            Kanji, KanjiMode, ImeKanji, Hanja, HanjaMode, ImeHanja = 25,
            ImeOff = 26,
            Escape = 27,
            ImeConvert = 28,
            ImeNonConvert = 29,
            ...
            ImeProcessed = 155,
            LShift, LeftShift = 160,
            RShift, RightShift = 161,
            LCtrl, LeftCtrl, LControl, LeftControl = 162,
            RCtrl, RightCtrl, RControl, RightControl = 163,
            LAlt, LeftAlt, LMenu, LeftMenu = 164,
            RAlt, RightAlt, RMenu, RightMenu = 165,
            BrowserBack = 166,
            BrowserForward = 167,
            BrowserRefresh = 168,
            BrowserStop = 169,
            ...
            Oem1, OemSemicolon, OemСolon = 186,
            OemPlus = 187,
            OemComma = 188,
            OemMinus = 189,
            OemPeriod, OemDot = 190,
            Oem2, OemSlash, OemQuestion = 191,
            Oem3, OemBackquote, OemBacktick, OemGrave, OemTilde = 192,
            Oem4, OemOpenBracket, OemLeftBracket, OemOpenSquareBracket, OemLeftSquareBracket, OemOpenBrace, OemLeftBrace, OemOpenCurlyBracket, OemLeftCurlyBracket = 219,
            Oem5, OemBackslash, OemVerticalBar, OemPipeline, OemPipe = 220,
            Oem6, OemCloseBracket, OemRightBracket, OemCloseSquareBracket, OemRightSquareBracket, OemCloseBrace, OemRightBrace, OemCloseCurlyBracket, OemRightCurlyBracket = 221,
            Oem7, OemQuote, OemSingleQuote, OemDoubleQuote = 222,
            Oem8 = 223,
            Oem102 = 226,
            ImeProcess = 229,
            Packet = 231,
